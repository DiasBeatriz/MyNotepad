...
namespace MyNotepad
{
    public partial class Form1 : Form
    {
        ...
        private void menuFicheiroAbrir_Click(object sender, EventArgs e)
        {
            ...
            openFileDialog1.Filter = "Ficheiros Texto (*.txt)|*.txt| Ficheiros RTF (*.rtf)|*.rtf| Todos (*.*)|*.*";
        ...
        private void Form1_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (!btnSair)
            {
                ...
                DialogResult resposta = MessageBox.Show("Deseja sair da aplicação?", "My Notepad",
                   MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void menuAbout_ButtonClick(object sender, EventArgs e)
        {
